...
export default function SignInPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-(--auth-bg-deep) text-(--text-primary) lg:grid lg:grid-cols-[minmax(0,13fr)_minmax(0,7fr)]">
      {/*
        ForceSignOut runs client-side as soon as this page mounts.
        It signs out any lingering Clerk session so the user must always
        authenticate from scratch — even if they closed the tab and reopened.
      */}
      <ForceSignOut />
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-8">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mb-8 max-w-lg text-base text-(--text-secondary)">
              Describe your architecture in plain English. Nexus AI maps it to a
                ...
                <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-(--accent-primary)/20 text-(--accent-primary)">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4"
                    />
                  </svg>
                </div>
                <div>
            ...
            <div className="overflow-hidden rounded-xl bg-(--auth-card-bg) px-4 py-5 backdrop-blur-xl">
              <SignIn
                ...
                appearance={{
                  ...
                  elements: {
                    rootBox:
                      "w-full [&_form]:gap-3 [&_form]:space-y-3",
