  ...
  return (
    <div className="relative inline-block group">
      <style>{`
        ...
        /* Removed static nth-child delays in favor of inline styles */
        ...
        <div className="gen-txt-wrapper">
          <div className="gen-txt-1">
            {text.split("").map((letter, i) => (
              <span key={`t1-${i}`} className="gen-btn-letter" style={{ animationDelay: `${i * 0.08}s` }}>
                {letter === " " ? "\u00A0" : letter}
              </span>
            ))}
          </div>
          <div className="gen-txt-2">
            {activeText.split("").map((letter, i) => (
              <span key={`t2-${i}`} className="gen-btn-letter" style={{ animationDelay: `${i * 0.08}s` }}>
                {letter === " " ? "\u00A0" : letter}
              </span>
            ))}
          </div>
