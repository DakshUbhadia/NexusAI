  ...
  return (
    <div className="relative inline-block">
      <style>{`
        ...
        @property --rg-color-1 { syntax: '<color>'; initial-value: #07070E; inherits: false; }
        @property --rg-color-2 { syntax: '<color>'; initial-value: #2a1f6d; inherits: false; }
        @property --rg-color-3 { syntax: '<color>'; initial-value: #06B6D4; inherits: false; }
        @property --rg-color-4 { syntax: '<color>'; initial-value: #c4b5fd; inherits: false; }
        @property --rg-color-5 { syntax: '<color>'; initial-value: hsl(252 80% 2.5%); inherits: false; }
        @property --rg-border-angle { syntax: '<angle>'; initial-value: 180deg; inherits: true; }
        @property --rg-border-color-1 { syntax: '<color>'; initial-value: hsla(258, 75%, 90%, 0.75); inherits: true; }
        @property --rg-border-color-2 { syntax: '<color>'; initial-value: hsla(190, 80%, 80%, 0.3); inherits: true; }
        ...
        .rg-button:hover {
          ...
          --rg-border-color-1: hsla(190, 85%, 80%, 0.15);
          --rg-border-color-2: hsla(258, 80%, 85%, 0.45);
